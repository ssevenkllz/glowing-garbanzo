...
NYC_LAT = 40.7580
NYC_LON = -73.9855
SEARCH_RADIUS = 5000  # ~3 miles — keeps it Manhattan focused

SEARCH_TERMS = [
    "restaurant Manhattan NYC",
    "bar Manhattan NYC",
    "cafe Manhattan NYC",
    "coffee shop Manhattan NYC",
    "brewery Manhattan NYC",
    "rooftop bar Manhattan NYC",
]
...
def ingest():
    ...
    for term in SEARCH_TERMS:
        ...
        try:
            places = search_places(term, NYC_LAT, NYC_LON, SEARCH_RADIUS)
