...
**Live Demo:** [ssevenkllz.github.io/glowing-garbanzo/chat_v3.html](https://ssevenkllz.github.io/glowing-garbanzo/chat_v3.html)  
...
├── chat_v3.html           # Full Copilot + Discover UI (streaming)
...
| chat_v1 | Full Copilot UI + Discover tab (non-streaming) |
...
python ingest_LFK_v1.py
python ingest_docs_v1.py
...
# Open: http://localhost:8080/chat_v3.html
```
